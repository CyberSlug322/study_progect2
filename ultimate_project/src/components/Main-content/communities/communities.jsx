...
export const Communities = (  ) => {
    return (
        <div className={style.communities}>
            ...
            <div className={style.community}>
                <div>
                <NavLink className={style.link} to={'/myCommunities/community2'}><img src={'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ6LltTo2X4YwzJnhf9F1kSRj9O0_EdfPXANg&usqp=CAU&reload=on'} alt={'nt found'}/></NavLink>
                <h4>tred title</h4>
                </div>
                <span>tred description Lorem ipsum dolor, sit amet consectetur adipisicing elit. Autem, nihil!</span>            
            </div>
